...
SET(STM32_CHIP_LINES 0x0 0x1 0x2 0x8 CACHE INTERNAL "stm32f0 chip line")
...
FUNCTION(STM32_SET_CHIP_DEFINITIONS TARGET CHIP_TYPE CHIP)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF]0[34579]([0128]).[468BC].*$" "\\1" STM32_LINE_CODE ${CHIP})
    ...
    IF(TARGET_DEFS)
        SET(TARGET_DEFS "STM32F0;STM32F0x${STM32_LINE_CODE};STM32F${CHIP_TYPE};${TARGET_DEFS}")
    ELSE()
        SET(TARGET_DEFS "STM32F0;STM32F0x${STM32_LINE_CODE};STM32F${CHIP_TYPE}")
    ENDIF()
